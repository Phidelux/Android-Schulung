...
\begin{frame}
   ...
   \lstinputlisting[
      language=xml,caption={Action View Deklaration},
...
\begin{frame}
   ...
   \begin{figure}[h!]
     \centering
     \subfigure[Action View zusammengeklappt]{\includegraphics[width=0.49\textwidth]{pictures/action_view.ps}}\hfill
     \subfigure[Action View ausgeklappt]{\includegraphics[width=0.49\textwidth]{pictures/action_view_expanded.ps}}
     \caption{
...
\begin{frame}
   ...
   \lstinputlisting[
      caption=Laden des Action Views,
...
\begin{frame}
   ...
   \begin{figure}[h!]
     \centering
     \subfigure[Action Spinner]{\includegraphics[width=0.49\textwidth]{pictures/action_spinner.ps}}\hfill
     \subfigure[Action Spinner ausgeklappt]{\includegraphics[width=0.49\textwidth]{pictures/action_spinner_expanded.ps}}
     \caption{
