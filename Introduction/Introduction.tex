...
\begin{frame}
   ...
   \lstinputlisting[language=xml,label={lst:strings.xml},
      caption={String Ressourcen}]{src/xml/strings.xml}
\end{frame}
...
\begin{frame}
   ...
   \lstinputlisting[language=xml,label={lst:colors.xml},
      caption={Farb Ressourcen}]{src/xml/colors.xml}
   
   \lstinputlisting[label={lst:resources.java},
   	caption={Zugriff auf Ressourcen}]{src/java/resources.java}
\end{frame}
...
\begin{frame}[label=activities]
   ...
   \lstinputlisting[label={lst:activity.java},
   	caption={Basisimplementation einer Activity}]{src/java/activity.java}
\end{frame}
...
\begin{frame}[label=explizit_intents]
   ...
   \lstinputlisting[caption={Starten einer Activity},
...
\begin{frame}
   ...
   \lstinputlisting[caption={Starten der Activity},
...
\begin{frame}
   \frametitle{Beispiel}
	\lstinputlisting[caption=Benachrichtigung,label={lst:email_notification.java}]{src/java/email_notification.java}
\end{frame}
